///////////////////////////////////////////////////////////////////////////////////////////////////
// MDH BOHEMIA REVIVE ICON MARKER MOD(by Moerderhoschi) - v2025-10-19
			...
			_mdhFnc =
			{
				...
				if (isNil"mdhBRIMmissionEH") then
				{
					...
					[
						...
						{
							{
								if (_x != player && {alive _x} && {side group player getFriend side group _x > 0.5} && {(lifeState _x) == "INCAPACITATED" OR _x getVariable ["AT_Revive_isUnconscious",false]} ) then
								{
				...
				{
					{
						if (side group player getFriend side group _x > 0.5 && {alive _x} && {(lifeState _x) == "INCAPACITATED" OR _x getVariable ["AT_Revive_isUnconscious",false]}) then
						{
